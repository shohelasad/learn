...
mvn exec:java -Dexec.mainClass="org.learn.util.DataImport" -Dexec.classpathScope="test" || exit 1

java -Dvraptor.webappdir=target/learn-1.0.0-SNAPSHOT/ \
	-Djava.security.policy=jetty/java.policy \
	-Ddeploy.timestamp=${TIMESTAMP} \
	-cp target/learn-1.0.0-SNAPSHOT/WEB-INF/classes/:target/learn-1.0.0-SNAPSHOT/WEB-INF/lib/* \
