...
import org.learn.integration.pages.ResetPasswordPage;
import org.learn.integration.util.ServerInfo;
...
public class ForgotPasswordTest extends AcceptanceTestBase implements ServerInfo.AcceptanceTest  {
    ...
    public static void setup() throws IOException {
        SessionFactoryCreator sessionFactoryCreator = new SessionFactoryCreator(new LearnDatabaseConfiguration(env, null, null));
