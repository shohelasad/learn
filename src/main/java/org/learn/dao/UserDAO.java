...
public class UserDAO {
    ...
    public UserAndSession findBySessionKey(String key) {
        Query query = session.createQuery("select new org.learn.dto.UserAndSession(user, session) from UserSession session " +
