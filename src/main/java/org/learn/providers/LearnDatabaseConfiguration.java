...
@ApplicationScoped
public class LearnDatabaseConfiguration {
	public static final String DATABASE_PROPERTY = "learn.database";
	private static final Logger LOGGER = LoggerFactory
			.getLogger(LearnDatabaseConfiguration.class);
	 ...
	 */
	public LearnDatabaseConfiguration() {
		this(null, null, null);
	}
	
	@Inject
	public LearnDatabaseConfiguration(Environment env, ValidatorFactory vf, LearnMetaInformation meta) {
		this.env = env;
		this.vf = vf;
		this.meta = meta;
	}
	...
	public void init(){
		...
		cfg.addAnnotatedClass(Channel.class);
		cfg.addAnnotatedClass(ChannelInformation.class);
		cfg.addAnnotatedClass(Page.class);
		cfg.addAnnotatedClass(PageInformation.class);
	}
