...
--
-- Table structure for table `TagDictionary`
--
...
CREATE TABLE `TagDictionary` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_24642shpebunaq3ggshotv9hk` (`bangla`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `Users_Watchers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;

CREATE TABLE `Users_Watchers` (
  `user_id` bigint(20) NOT NULL,
  `watchers_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_5twinfe7e6g09gaowkeah04982` (`watchers_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `Channel` (
  ...
  `lastTouchedBy_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_a3dib35x299yvhfk7pau0kw5w2` (`author_id`),
  KEY `FK_i2xt9jcwfauudnswun94neqyg2` (`information_id`),
  KEY `FK_9d3cyy648wfruj9t7556wqgjr2` (`lastTouchedBy_id`),
  CONSTRAINT `FK_9d3cyy648wfruj9t7556wqgjr2` FOREIGN KEY (`lastTouchedBy_id`) REFERENCES `Users` (`id`),
  CONSTRAINT `FK_a3dib35x299yvhfk7pau0kw5w2` FOREIGN KEY (`author_id`) REFERENCES `Users` (`id`),
  CONSTRAINT `FK_i2xt9jcwfauudnswun94neqyg2` FOREIGN KEY (`information_id`) REFERENCES `ChannelInformation` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `ChannelInformation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ChannelInformation` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_9nfk2kchvyn69e7gdh798gf2` (`author_id`),
  KEY `FK_t1oox0xh74vlikcvhxd5k2kq12` (`moderatedBy_id`),
  KEY `FK_pl1drgbxhfd4hbmd3smwa3svl2` (`channel_id`),
  CONSTRAINT `FK_9nfk2kchvyn69e7gdh798gf2` FOREIGN KEY (`author_id`) REFERENCES `Users` (`id`),
  CONSTRAINT `FK_pl1drgbxhfd4hbmd3smwa3svl2` FOREIGN KEY (`channel_id`) REFERENCES `Channel` (`id`),
  CONSTRAINT `FK_t1oox0xh74vlikcvhxd5k2kq12` FOREIGN KEY (`moderatedBy_id`) REFERENCES `Users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=207 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Channel_Tag` (
  ...
  `tags_id` bigint(20) NOT NULL,
  `tag_order` int(11) NOT NULL,
  PRIMARY KEY (`channel_id`,`tag_order`)
);

DROP TABLE IF EXISTS `Channel_Watchers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `Channel_Watchers` (
  `channel_id` bigint(20) NOT NULL,
  `watchers_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_5twinfe7e6g09gaowkeah04981` (`watchers_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `Channel_Attachment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;

CREATE TABLE `Channel_Attachment` (
  `channel_id` bigint(20) NOT NULL,
...
CREATE TABLE `Page` (
  ...
  `lastTouchedBy_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_a3dib35x299yvhfk7pau0kw5w1` (`author_id`),
  KEY `FK_i2xt9jcwfauudnswun94neqyg1` (`information_id`),
  KEY `FK_9d3cyy648wfruj9t7556wqgjr1` (`lastTouchedBy_id`),
  CONSTRAINT `FK_9d3cyy648wfruj9t7556wqgjr1` FOREIGN KEY (`lastTouchedBy_id`) REFERENCES `Users` (`id`),
  CONSTRAINT `FK_a3dib35x299yvhfk7pau0kw5w1` FOREIGN KEY (`author_id`) REFERENCES `Users` (`id`),
  CONSTRAINT `FK_i2xt9jcwfauudnswun94neqyg1` FOREIGN KEY (`information_id`) REFERENCES `PageInformation` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PageInformation` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_9nfk2kchvyn69e7gdh798gf11` (`author_id`),
  KEY `FK_t1oox0xh74vlikcvhxd5k2kq111` (`moderatedBy_id`),
  KEY `FK_pl1drgbxhfd4hbmd3smwa3svl1` (`page_id`),
  CONSTRAINT `FK_9nfk2kchvyn69e7gdh798gf11` FOREIGN KEY (`author_id`) REFERENCES `Users` (`id`),
  CONSTRAINT `FK_pl1drgbxhfd4hbmd3smwa3sv1l1` FOREIGN KEY (`page_id`) REFERENCES `Page` (`id`),
  CONSTRAINT `FK_t1oox0xh74vlikcvhxd5k2kq111` FOREIGN KEY (`moderatedBy_id`) REFERENCES `Users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=207 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `PageInformation_Tag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PageInformation_Tag` (
  `PageInformation_id` bigint(20) NOT NULL,
  `tags_id` bigint(20) NOT NULL,
  `tag_order` int(11) NOT NULL,
  PRIMARY KEY (`PageInformation_id`,`tag_order`),
  KEY `FK_nv1tmcost5jqejnlb6u0wrypo1` (`tags_id`),
  KEY `FK_7u4x47xa5gdhmt650curhu3kx1` (`PageInformation_id`),
  CONSTRAINT `FK_7u4x47xa5gdhmt650curhu3kx1` FOREIGN KEY (`PageInformation_id`) REFERENCES `PageInformation` (`id`),
  CONSTRAINT `FK_nv1tmcost5jqejnlb6u0wrypo1` FOREIGN KEY (`tags_id`) REFERENCES `Tag` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `Page_Flags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Page_Flags` (
  `page_id` bigint(20) NOT NULL,
  `flags_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_a8brcb8bpevccipiyplquqqjv1` (`flags_id`),
  KEY `FK_a8brcb8bpevccipiyplquqqjv1` (`flags_id`),
  KEY `FK_ftntexa7hxbaqo2i2yg4i0yr31` (`page_id`),
  CONSTRAINT `FK_a8brcb8bpevccipiyplquqqjv1` FOREIGN KEY (`flags_id`) REFERENCES `Flag` (`id`),
  CONSTRAINT `FK_ftntexa7hxbaqo2i2yg4i0yr31` FOREIGN KEY (`page_id`) REFERENCES `Page` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `Page_Votes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Page_Votes` (
  `page_id` bigint(20) NOT NULL,
  `votes_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_p5sgssf0gw0br66mvu9cctlmq1` (`votes_id`),
  KEY `FK_p5sgssf0gw0br66mvu9cctlmq1` (`votes_id`),
  KEY `FK_24u6uwfjr8s8pfk7oyfw8u4o41` (`page_id`),
  CONSTRAINT `FK_24u6uwfjr8s8pfk7oyfw8u4o41` FOREIGN KEY (`page_id`) REFERENCES `Page` (`id`),
  CONSTRAINT `FK_p5sgssf0gw0br66mvu9cctlmq1` FOREIGN KEY (`votes_id`) REFERENCES `Vote` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Page_Watchers` (
  ...
  `watchers_id` bigint(20) NOT NULL,
  UNIQUE KEY `UK_5twinfe7e6g09gaowkeah04981` (`watchers_id`),
  KEY `FK_5twinfe7e6g09gaowkeah04981` (`watchers_id`),
  KEY `FK_pu72rhjonka0flev96adthdp01` (`page_id`),
  CONSTRAINT `FK_5twinfe7e6g09gaowkeah04981` FOREIGN KEY (`watchers_id`) REFERENCES `Watcher` (`id`),
  CONSTRAINT `FK_pu72rhjonka0flev96adthdp01` FOREIGN KEY (`page_id`) REFERENCES `Page` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
--
