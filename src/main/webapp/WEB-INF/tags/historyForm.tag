...
<%@attribute name="information" type="org.learn.model.Information" required="true" %>
...
<%@attribute name="touchable" type="org.learn.model.interfaces.Touchable" required="false" %>
	...
	<form method="post" class="history-form moderate-form" action="${linkTo[HistoryController].publish(0, type, 0, '')}">
		...
		<ul class="post-touchs clear">
			<li class="touch author-touch">
				<tags:completeUser user="${information.author}" touchable="${touchable}">
