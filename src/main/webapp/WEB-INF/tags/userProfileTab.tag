...
<%@attribute name="user" type="org.learn.model.User" required="false" %>

<section class="basic-user-data user-data">
	<!-- <div class="subheader"> -->
	
	<div style="margin-top:1em;" class="image-and-information">
		...
		<tags:userProfileLink user="${selectedUser}" htmlClass="title page-title"/>
			<ul class="subheader-menu">
				<c:if test="${isCurrentUser}">
						<%-- <li><a href="${linkTo[UserProfileController].editProfile(selectedUser)}">
							${t['user_profile.edit']}
						</a></li> --%>
						<li><a href="${linkTo[UserProfileController].editProfile(selectedUser)}">
				...
				<c:if test="${!isCurrentUser}">
					<li>
						<tags:followFor watchable="${user}" type="${t['user.type_name']}"/>
					</li>
				</c:if>
	...
	<div>
		<span class="karma1">${selectedUser.karma}</span>
	...
	<ul class="data-list">
		<li class="data-line">
			...
			<dl class="data-section">
				...
				<%-- <dt class="data-title ellipsis">${t['user_profile.occupation']}</dt> --%>
				<dd class="data-description ellipsis"><c:out value="${selectedUser.occupation}" escapeXml="true"/></dd>
				<%-- <dt class="data-title ellipsis">${t['user_profile.organization']}</dt> --%>
				<dd class="data-description ellipsis"><c:out value="${selectedUser.organization}" escapeXml="true"/></dd>
