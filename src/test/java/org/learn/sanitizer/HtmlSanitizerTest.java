...
import static org.learn.sanitizer.HtmlSanitizer.ALLOWED_ATTRIBUTES_KEY_PREFIX;
import static org.learn.sanitizer.HtmlSanitizer.ALLOWED_ATTRIBUTES_WHITELIST_KEY_SUFIX;
import static org.learn.sanitizer.HtmlSanitizer.ALLOWED_ELEMENTS_KEY;
import static org.mockito.Mockito.when;

import org.junit.Before;
import org.junit.Test;
import org.junit.runner.RunWith;
import org.learn.sanitizer.HtmlAttributesBuilder;
import org.learn.sanitizer.HtmlElementsBuilder;
import org.learn.sanitizer.HtmlSanitizer;
import org.learn.sanitizer.LearnPolicyProducer;
...
public class HtmlSanitizerTest {
	...
	public void setUp(){
		...
		LearnPolicyProducer learnPolicyProducer = new LearnPolicyProducer(htmlElementsBuilder);
		learnPolicyProducer.setUp();
		PolicyFactory policy = learnPolicyProducer.getInstance();
