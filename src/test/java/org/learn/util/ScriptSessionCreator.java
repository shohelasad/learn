...
public class ScriptSessionCreator {
    ...
    public ScriptSessionCreator() {
    	...
    	LearnDatabaseConfiguration learnDatabaseConfiguration = new LearnDatabaseConfiguration(env, null, null);
    	sessionFactoryCreator = new SessionFactoryCreator(learnDatabaseConfiguration);
